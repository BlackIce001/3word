...
public class Main  {
    public static void main(String[] args) {
        ...
        // Create n sentences with more than 3 words and a maximum length of 10 words
        int n = 5; // Change this to the desired number of sentences
        Random random = new Random();

        for (int i = 0; i < n; i++) {
            StringBuilder sentence = new StringBuilder();
            int sentenceLength = random.nextInt(7) + 4; // Generate a random sentence length between 4 and 10
